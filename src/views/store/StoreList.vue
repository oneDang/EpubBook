...
<template>
  <div class="book-list-wrapper">
    ...
    <scroll class="book-list-scroll-wrapper" :top="42" :bottom="52" @onScroll="onScroll" ref="scroll">
      <featured :data="value" :titleText="titleText ? titleText : getCategoryText(key)" :btnText="''"
        v-for="(value, key, index) in list" :key="index"></featured>
    </scroll>
  </div>
</template>
